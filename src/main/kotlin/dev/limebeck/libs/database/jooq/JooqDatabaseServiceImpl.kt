...
import dev.limebeck.libs.database.DataSourceProvider
import dev.limebeck.libs.database.PostgresDataSourceProvider
import dev.limebeck.libs.database.Transaction
import dev.limebeck.libs.database.TransactionWithDBConnection
...
import dev.limebeck.libs.logger.warn
...
class JooqDatabaseServiceImpl(
    ...
    private inner class DBTransaction(
        ...
        override val childTransactionsCounter: AtomicInteger = AtomicInteger()
    ...
    private inner class DBNestedTransaction(
        ...
        override val childTransactionsCounter = AtomicInteger()
